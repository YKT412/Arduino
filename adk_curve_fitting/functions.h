...
float scaling_factor = 6.3; //mapping factor of encoder and degree values //6.3
...
void set_actuator (uint16_t desired_deg) {
  ...
  diff_counts = (int)((desired_deg) - encoder_counts);
...
void input_constrain () {
  ...
  desired_V_pos = constrain(desired_V_pos, 0, 270);
