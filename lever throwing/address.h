...
#define intr0 point(0x400140f0)
#define intr0_set point(0x400140f0+0x2000)
#define intr0 point(0x400140f0)
#define intr1 point(0x400140f4)
#define intr2 point(0x400140f8)

#define proc0_inte0 point(0x40014100)  
#define proc0_inte1 point(0x40014104)
#define proc0_inte2 point(0x40014108) 

#define proc0_ints0 point(0x40014120)
#define proc0_ints1 point(0x40014124)
#define proc0_ints2 point(0x40014128)
//EDGE HIGH, EDGE LOW, LEVEL HIGH, LEVEL LOW
// 0 --> 0 to 7 |  1 --> 8 to 15 |  2 --> 16 to 23
/* GPIO17_EDGE_LOW ---> 6
*/
 ...
 */
 ...
 #define pwm_inte point(0x400500a8)
 #define pwm_ints point(0x400500b0)
 #define pwm_intr point(0x400500a4)
