...
void print_dist () {
  ...
  Serial.print("  ");
  Serial.print((180 - phi2) * 8.889); //dist2
  Serial.print("  ");
  Serial.print(dist1);
  Serial.print("  ");
  Serial.print(target_dist2);
  Serial.print("  ");
  Serial.print(dist2); //dist2
  Serial.print("  ");
  Serial.println(prev_dist2);
  //    Serial.print("  ");
  //    Serial.println((1600 - target_step1) * 0.1125);
}
...
void set_stepper() {
  if (!flag) {
    ...
    if (set == 1000) {
      ...
      angle_calculation2 (target_step2, prev_dist2);
      set_pos1((180 - phi2) * 8.8889);
      //        set_pos1(target_step1);
      //      angle_calculation1 ((1600 - target_step1), prev_dist1);
      //      set_pos2((phi1) * 8.8889);
      flag = 1;
    }
  }
  else {
