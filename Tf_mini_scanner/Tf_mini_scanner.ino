...
bool dir_flag;
char dirf = 1;
uint8_t c = 0, check = 2, a = 1, m = 0, n = 0;
uint16_t min_dist = 1200, min_steps = 0, deg = 0;
...
double target_dist = 0, target_angle = 0, dist_of_sep = 7.5, offset = 4.2, rad = 0;
...
void angle_calculation(unsigned int steps, unsigned int d) {
  rad = (steps * 0.00196);
